...
uint256 hashGenesisBlock("0x7e555810a98c988850d74b1342babea899df10f7c5b1311ea32b496e5e68d5bc");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Ponscoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Ponscoin Signed Message:\n";
...
{
    // Ponscoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Ponscoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Ponscoin: 3.5 days
static const int64 nTargetSpacing = 150; // Ponscoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Ponscoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Ponscoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Ponscoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xefa156ee56357666b47aa44246fa7b065aa456adbd615669cc0d88ea77c5c2bb");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("dfb37df43d9237755c14d747e44ce5d0c35d444d02eac81de7d8de81221937dbb9267f43c1f48dce5d4d3d0fdd011570a96df7f7c8b513374fd7c627fa7232b81c") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1508482658;
        block.nBits    = 504365644;
        block.nNonce   = 877700108;

        if (fTestNet)
        {
            block.nTime    = 1508482658;
            block.nNonce   = 2762493253;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb4f50b6a609d360b91b3af9024afd097644f12bd4016a47f72dd4cbfe4ecff2b"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Ponscoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PonscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PonscoinMiner : ProcessBlock, block not accepted");
    }
